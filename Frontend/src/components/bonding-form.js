...
const Bonding = () => {
  ...
  const validateStage = () => {
    ...
    const requiredFields = {
      ...
      2: ['University', 'ProgramOfStudy','YearOfStudy', 'RegNo', 'email'],
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      const response = await axios.post(`https://group15-com31.onrender.com/register/user/${userId}`, {   
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="YearOfStudy" value={form.YearOfStudy} onChange={handleChange} className="w-full px-4 py-3 border border-indigo-500 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
